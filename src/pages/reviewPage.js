...
export default function ReviewPage({setResult, setSelectRes, result}) {
  ...
  return(<div className="wrapper">
    ...
    <div className="emoji-card">
      ...
      <img src="./hearteomji.png" alt="heart" className={emojiSelect==1 ? ("heartactive") : ("heartEmoji")} onClick={() => setEmoji(1)}/>
      <img src="./fireEmoji.png" alt="fire" className={emojiSelect==2 ? ("fireactive") : ("fireEmoji")} onClick={() => setEmoji(2)}/>
      <img src="./question-mark-emoji.png" alt="heart" className={emojiSelect==3 ? ("qmarkactive") : ("qmarkEmoji")} onClick={() => setEmoji(3)}/>
    </div>
